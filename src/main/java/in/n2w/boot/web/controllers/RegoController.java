...
public class RegoController {
    ...
    public ModelAndView registerUser(@Valid final User user, final BindingResult result, final HttpServletRequest request) {
        ...
        try {
            ...
            // TODO this id for dev only but eventually there should be better way out for this
    ...
    public ModelAndView savePassword(@RequestParam("password") final String password, @RequestParam("passwordConfirmation") final String passwordConfirmation, final RedirectAttributes redirectAttributes) {
        if (!password.equals(passwordConfirmation)) {
            return new ModelAndView("reset-password", ImmutableMap.of("errorMessage", "Passwords do not match"));
        }
